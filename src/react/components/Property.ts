...
export class PropertyComp extends React.PureComponent<PropertyPropTypes> {
    ...
    public render() {
        ...
        if (this.props.children) {
            return React.createElement(associationRenderer, this.props, this.props.children);
        }
    ...
    private limitTimes(
        ...
        if (objRaw.length === 0) {
            ...
            return React.createElement(associationRenderer, this.props, func(objRaw[0]));
        ...
        return React.createElement(associationRenderer, this.props, elems);
    }
}
